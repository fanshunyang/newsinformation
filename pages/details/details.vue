<template>
	<view class="content">
	  <view class="status_bar">
		  ...
		  <view class="contentsy-nav">
			 <view class="contentsy-nav-icon el-icon-arrow-left" @click="iconleft">
			  
			  </view>
			  <view class="contentsy-nav-text-item">
				  <view class="contentsy-nav-text-item-li" :class="{'contentsy-nav-text-item-area':currindex===index}" @click="changeclick(index)" v-for="(item,index) in navbar" :key='index'>
				  	{{item.title}}
				  </view>
	...
	<!-- 	<view class="" style="height: 20px; position: fixed; bottom: 0px; z-index: 2234; background-color: red;">
			222222
		</view> -->
		  <swiper class="swiper-boxt" :current="currindex" @change="changtable">
		  	<swiper-item>
		...
		<popup  ref="popup" type="bottom">
			<view class="transmit" >
				<view class="transmit-top">
					<view class="transmit-top-left">
						分享
					</view>
					<view class="transmit-top-right"  @click="retransmission">
						立即转发
					</view>
				...
				<view class="transmit-distinction-ul">
					...
					<view class="transmit-distinction-li-item">
						...
						<view class="transmit-distinction-li-text">
							微信
						</view>
					</view>
				...
				<view class="countermand" @click="countermand">
					取消
				</view>
			</view>
	...
	.content {
		...
		.contentsy-nav {
					...
					z-index: 222222;
					 ...
					 .contentsy-nav-text-item {
						 display: flex;
						 .contentsy-nav-text-item-area {
							color: #1482FF  !important;
							font-weight: 700 !important;
							width: 71upx !important;
							height: 52upx !important;
							font-size: 32upx !important;
							font-family: Microsoft YaHei !important;
							color: #1482FF;
							line-height: 34upx !important;
							border-bottom: 2px solid #1482FF;
						 }
						 .contentsy-nav-text-item-li {
							 width: 61upx;
							 height: 28upx;
							 font-size: 28upx;
							 font-family: Microsoft YaHei;
				...
				.text-part-ul {
					.text-part-li {
						...
						.text-part-li-title {
							...
							color: #333333;
							line-height: 50upx;
							margin: 24upx 40upx 43upx 30upx ;
