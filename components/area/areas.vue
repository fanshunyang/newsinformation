	...
	<view class="mask" :class="maskState===0 ? 'none' : maskState===1 ? 'show' : ''" @click="toggleMask">
		<view class="mask-content"  @click.stop.prevent="stopPrevent">
			<view class="mask-content-topbar" >
				<view class="mask-content-topbar-img">
					{{va.id || va.reply_id}}
				</view>
				<view class="mask-content-topbar-desc">
					{{va.desc}}
				</view>
				<!-- <view class="left" @click="toggleMask">取消</view> -->
				<view class="right" @click="pubComment">回复</view>
			</view>
	...
	.mask{
		...
		.mask-content{
			...
			.mask-content-topbar{
				...
				.mask-content-topbar-img {
					
				}
				.mask-content-topbar-desc {
				  width: 400upx;
					overflow: hidden;
